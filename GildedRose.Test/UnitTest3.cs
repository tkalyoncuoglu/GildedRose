...
namespace GildedRose
{
    class TestsFromGithub
    {
        ...
        private GildedRose.Console.Program sut;

        [SetUp]
        public void Initialize()
        {
            dexterityVest = new Item() { Name = "+5 Dexterity Vest" };
            agedBrie = new Item() { Name = "Aged Brie" };
            elixir = new Item() {Name = "Elixir of the Mongoose"};
            sulfuras = new Item() {Name = "Sulfuras, Hand of Ragnaros"};
            backstagePasses = new Item() { Name = "Backstage passes to a TAFKAL80ETC concert" };
            conjured = new Item() { Name = "Conjured Mana Cake" };
            sut = new Program() { Items = new List<Item>() { dexterityVest, agedBrie, elixir, sulfuras, backstagePasses, conjured } };
        }
